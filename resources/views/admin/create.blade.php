    ...
    <div class="space-y-6">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-6 rounded-lg shadow-sm">
            <div>
                ...
                <p class="text-gray-600 mt-1">Tambahkan alat elektronik baru ke dalam sistem</p>
            </div>
        </div>

        <!-- Form Section -->
        <div class="bg-white rounded-lg shadow-sm p-6">
            <form action="{{ route('alat.store') }}" method="POST" enctype="multipart/form-data" id="createForm" class="space-y-6">
                @csrf
                ...
                <div class="space-y-2">
                    ...
                    <div id="imagePreview" class="hidden mt-4">
                        <img id="preview" src="#" alt="Preview" class="max-h-48 rounded-lg shadow-sm">
